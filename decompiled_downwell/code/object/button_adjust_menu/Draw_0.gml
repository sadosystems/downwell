...
scrDrawBorderTextBlack(vx + 80, vy + 72 + wholePowan, pauseText + "##" + string(global.tabletButtonAdjustx));
...
for (i = 0; i <= maxMenu; i += 1)
{
    ...
    apartByx = 8;
    apartByy = 10;
    menuTexty = ditheryTop + 20 + (i * apartByy) + powany + wholePowan2 + 32 + 16;
    menuTextx = vx + 32 + (i * apartByx) + 32;
